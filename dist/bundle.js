...
(function($PS) {
  ...
  var printCoin = function (v) {
      var prices = Data_Foldable.foldl(Data_Foldable.foldableArray)(function (str) {
          return function (v1) {
              return v1.name + (": " + (Chalk.greenBright(Data_String_Utils.padEnd(12)(Data_Show.show(Data_Show.showNumber)(v1.value))) + str));
          };
      })("")(v.prices);
      return Effect_Console.log(Chalk.cyan(Data_String_Utils.padEnd(8)(v.name)) + prices);
  };
      ...
      return function (currs) {
          return Effect_Aff.launchAff_((function () {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Axios.axios(Remote_Types.axiosGetPriceForCryptos)(req))((function () {
                  var $38 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
                  return function ($39) {
                      return $38((function (v) {
                          ...
                          if (v instanceof Data_Either.Right) {
                              return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(printCoin)(v.value0.results);
                          };
                          throw new Error("Failed pattern match at Main (line 46, column 32 - line 48, column 73): " + [ v.constructor.name ]);
                      })($39));
                  };
              })());
          })());
  ...
  var main = (function () {
      var values = (function () {
          var v = Data_Array.index(Data_Functor.map(Data_Functor.functorArray)(getValues)(args))(1);
          var v1 = Data_Array.index(Data_Functor.map(Data_Functor.functorArray)(getValues)(args))(0);
          if (v1 instanceof Data_Maybe.Just && (v1.value0.value0 === "coins" && (v instanceof Data_Maybe.Just && v.value0.value0 === "currs"))) {
              return new Data_Tuple.Tuple(v1.value0.value1, v.value0.value1);
          };
          if (v1 instanceof Data_Maybe.Just && v1.value0.value0 === "coins") {
              return new Data_Tuple.Tuple(v1.value0.value1, "USD,INR");
          };
          return new Data_Tuple.Tuple("", "");
      })();
      if (values.value0 === "" && values.value1 === "") {
          return Effect_Console.log("No Coins Found");
      };
      return getPriceForCryptos(values.value0)(values.value1);
  })();
  exports["args"] = args;
